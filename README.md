...
Внимание! В скоростных режимах радиомодули нагреваются при передаче, проверяйте температуру! При необходимости установите радиаторы и даже кулер на TX. Максимальное значение мощности для 30s модулей (1вт) - число 17. Для 20s (0.1вт) - 20. Минимум есть смысл ставить не ниже 10, иначе модуль 1вт нагревается сильнее при меньшей мощности.
