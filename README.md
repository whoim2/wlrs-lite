...
### Общая информация
Система радиоуправления хоббийного направления, поддерживающая SBUS и MAVLINK v1, также Frsky S.Port на TX (требует тестов и отладки). С версии 008 присутствует возможность подключать TX к CRSF, например, приемники elrs/tbs.
